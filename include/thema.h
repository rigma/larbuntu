...
/**
 * @fn thema_removeBook(thema_t *thema, book_t *book)
 * @brief Enlève un livre dans un thème donné
 * @author Romain FAILLA
 * @param thema_t *thema : le thème concerné
 * @param book_t *book : le livre concerné
 * @return char
 */
